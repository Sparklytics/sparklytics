/**
 * ISO 3166-1 numeric code (zero-padded 3-digit string) → alpha-2 code
 * Used to correlate world-atlas TopoJSON features (which use numeric IDs) with
 * our MetricRow.value strings (which are alpha-2 codes).
 *
 * Source: ISO 3166-1 numeric codes (= UN M.49 codes used by world-atlas)
 */
export const ISO_NUMERIC_TO_A2: Record<string, string> = {
  ...
  '070': 'BA', '072': 'BW', '076': 'BR', '084': 'BZ', '086': 'IO',
  '090': 'SB', '092': 'VG', '096': 'BN', '100': 'BG', '104': 'MM',
  '108': 'BI', '112': 'BY', '116': 'KH', '120': 'CM', '124': 'CA',
  '132': 'CV', '136': 'KY', '140': 'CF', '144': 'LK', '148': 'TD',
  '152': 'CL', '156': 'CN', '158': 'TW', '162': 'CX', '166': 'CC',
  ...
  '233': 'EE', '238': 'FK', '242': 'FJ', '246': 'FI', '248': 'AX',
  '250': 'FR', '258': 'PF', '262': 'DJ', '266': 'GA', '268': 'GE',
  ...
  '534': 'SX', '535': 'BQ', '540': 'NC', '548': 'VU', '554': 'NZ',
  '558': 'NI', '562': 'NE', '566': 'NG', '574': 'NF', '578': 'NO',
