...
3. Cross-reference `AGENTS.md` critical facts that apply to this sprint.
...
### Files to Create
List every file to create with its exact path per the workspace layout in AGENTS.md:
...
List any AGENTS.md critical facts that are especially relevant to this sprint (e.g. tenant_id=NULL, rate limit=60/min, visitor ID formula).
